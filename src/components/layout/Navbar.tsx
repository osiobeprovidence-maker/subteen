...
import { isAdminItemActive } from '../../lib/adminNavigation';
...
export const Navbar = () => {
  ...
  const currentLinks: { name: string; path: string; subcategories?: string[] }[] = isEditorPath
    ? EDITOR_LINKS
    : publicLinks;
